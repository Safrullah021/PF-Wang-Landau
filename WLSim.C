  ...
  void GetObservablesHP()
{
  ...
  // trial move
  void GetObservablesPartHP(int nmin, int nmax, long int sign)
{
...
public:
  ...
  unsigned long int RngSeed = 5;      // benih random number generator                 
  ...
  void WangLandauSampling(Histogram* h, HPModel* m)
{
