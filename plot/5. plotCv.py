...
N = 39      # Jumlah monomer dari urutan asam amino protein
eHH = 1     # Nilainya diambil 1 untuk memudahkan
...
ax1.plot(T, (Cv/N), color = "blue", linestyle='solid', linewidth=2, marker='.', markerfacecolor='blue', markersize=8)

ax2 = ax1.twinx()
ax2.plot(T, (Rgrata/N), color = "green", linestyle='solid', linewidth=2, marker='.', markerfacecolor='green', markersize=8)

ax3 = ax1.twinx()
ax3.plot(T, Taurata, color = "red", linestyle='solid', linewidth=2, marker='.', markerfacecolor='red', markersize=8)
